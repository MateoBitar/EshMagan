...
import { View, Text, TouchableOpacity, ScrollView, SafeAreaView, Animated, Easing } from 'react-native';
    ...
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.card}>
          ...
          <TouchableOpacity style={styles.primaryBtn} onPress={() => navigation.navigate('Evacuation')}>
