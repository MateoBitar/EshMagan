...
export default StyleSheet.create({
  ...
  headerLogoIcon: { width: 42, height: 42, backgroundColor: 'rgba(255,255,255,0.25)', borderRadius: 12, alignItems: 'center', justifyContent: 'center' },
  ...
  statusCard: { backgroundColor: '#fff', borderRadius: 20, padding: 20, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.1, shadowRadius: 12, elevation: 6 },
  ...
  firesCount: { backgroundColor: '#f1f5f9', borderRadius: 8, paddingHorizontal: 10, paddingVertical: 4 },
  firesCountText: { fontSize: 12, fontWeight: '600', color: '#475569' },
  emptyBox: { backgroundColor: '#f0fdf4', borderWidth: 2, borderColor: '#bbf7d0', borderRadius: 16, padding: 20, alignItems: 'center' },
  emptyEmoji: { fontSize: 32, marginBottom: 8 },
  emptyText: { color: '#15803d', fontWeight: '600' },
  fireCard: { backgroundColor: '#fff', borderWidth: 2, borderColor: '#e2e8f0', borderRadius: 16, padding: 16, marginBottom: 10, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.06, shadowRadius: 8, elevation: 3 },
  ...
  fireArrow: { marginLeft: 'auto', fontSize: 14, color: '#94a3b8' },
  contactsSection: { paddingHorizontal: 20, paddingBottom: 30 },
  contactCard: { backgroundColor: '#fff', borderWidth: 2, borderColor: '#e2e8f0', borderRadius: 16, padding: 16, marginBottom: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
