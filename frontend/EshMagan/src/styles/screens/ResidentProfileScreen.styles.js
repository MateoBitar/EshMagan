...
export default StyleSheet.create({
  ...
  avatarCard: {
    ...
    alignItems: 'center', marginBottom: 16, ...shadows.sm,
  },
  avatarCircle: {
    width: 88, height: 88, borderRadius: 44, backgroundColor: '#3b82f6',
  ...
  logoutBtn: {
    height: 50, borderRadius: 14, borderWidth: 2, borderColor: '#fecaca',
