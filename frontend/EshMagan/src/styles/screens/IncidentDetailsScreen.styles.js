...
export default StyleSheet.create({
  ...
  mainCard: { backgroundColor: '#fff', borderRadius: 20, padding: 20, marginBottom: 16, borderWidth: 2, borderColor: '#fecaca' },
  mainCardHeader: { flexDirection: 'row', alignItems: 'center', gap: 12, marginBottom: 16 },
  mainCardIcon: { width: 50, height: 50, alignItems: 'center', justifyContent: 'center' },
  mainLogoImage: { width: 50, height: 50 },
  ...
  sectionCard: { backgroundColor: '#fff', borderRadius: 16, padding: 16, marginBottom: 16, borderWidth: 1, borderColor: '#e2e8f0', boxShadow: '0px 2px 8px rgba(0, 0, 0, 0.06)' },
